...
set.seed(1)
od=file.path("C:/Users/18904/Github/huashu-cup","解答","5-灵敏度分析");bp=file.path("C:/Users/18904/Github/huashu-cup","解答","0-数据预处理");ap=file.path("C:/Users/18904/Github/huashu-cup","题目","附件数据")
...
sched=function(cp,W=48,K=5){ecm=price+cp*ci;cvm=apply(ecm,2,function(v)c(0,cumsum(v)))
